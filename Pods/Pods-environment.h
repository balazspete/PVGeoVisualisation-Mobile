...
#define COCOAPODS_VERSION_MAJOR_MKPolygon_GPC 0
#define COCOAPODS_VERSION_MINOR_MKPolygon_GPC 0
#define COCOAPODS_VERSION_PATCH_MKPolygon_GPC 1

// SkyLab
#define COCOAPODS_POD_AVAILABLE_SkyLab
#define COCOAPODS_VERSION_MAJOR_SkyLab 1
#define COCOAPODS_VERSION_MINOR_SkyLab 0
#define COCOAPODS_VERSION_PATCH_SkyLab 0
